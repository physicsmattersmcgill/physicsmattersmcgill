...
<xsl:template match="/rss">
	...
	<link rel="canonical" href="http://localhost:4000/physicsmattersmcgill/assets/xslt/rss.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="RSS Feed (Styled)">
	<meta property="og:description" content="This is the website for the McGill Physics department&#39;s outreach group.">
	<meta property="og:url" content="http://localhost:4000/physicsmattersmcgill/assets/xslt/rss.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
          ...
          <li class="divider"></li>
          <li><a href="http://localhost:4000/physicsmattersmcgill/assets/xsltrss.x/">en</a></li>

        
          

          <li class="divider"></li>
          <li><a href="http://localhost:4000/physicsmattersmcgill/assets/xsltrss.x_fr/">fr</a></li>
