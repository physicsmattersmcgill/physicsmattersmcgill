...
<xsl:template match="/rss">
	...
	<link rel="canonical" href="http://localhost:4000/physicsdraft/assets/xslt/rss.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="RSS Feed (Styled)">
	<meta property="og:description" content="This is the website for the McGill Physics department&#39;s outreach group.">
	<meta property="og:url" content="http://localhost:4000/physicsdraft/assets/xslt/rss.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/physicsdraft/" class="icon-tree"> Physics Matters McGill</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
          ...
          <li class="divider"></li>
          <li><a href="http://localhost:4000/physicsdraft/assets/xsltrss.x/">en</a></li>

        
          

          <li class="divider"></li>
          <li><a href="http://localhost:4000/physicsdraft/assets/xsltrss.x_fr/">fr</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/physicsdraft/" title="Physics Matters McGill – McGill Physics Outreach">
				<img src="http://localhost:4000/physicsdraft/assets/img/logo.png" alt="Physics Matters McGill – McGill Physics Outreach">
			</a>
        ...
        <div class="row">
          ...
          <div class="small-6 medium-3 large-3 columns">
            ...
            <ul class="no-bullet shadow-black">
                ...
                <li class="logo-phma" >
                  <a href="http://www.physics.mcgill.ca/~chuinard/" target="_blank"  title="Anabel Chuinard"></a>
                </li>
            
              
                <li class="logo-spaceexplorers" >
                  <a href="http://msi.mcgill.ca/Contact.html" target="_blank"  title="Kelly Lepo"></a>
                </li>
